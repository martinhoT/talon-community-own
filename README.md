...
> [!Note]
> This is a modification of the original Talon community repository, to suit my needs.
> It focuses on changing and removing original functionality, not adding to it. Personal additions are [here](https://github.com/martinhoT/talon-own).
